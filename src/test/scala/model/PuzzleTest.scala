...
class PuzzleSuite extends munit.FunSuite:
  ...
  test("Solvable puzzle is recognised as such") {
    val puzzle = Puzzle.createPuzzleFromTiles(Map(((1, 1), Number(13)),
                                                 ((1, 2), Number(2)),
                                                 ((1, 3), Number(10)),
                                                 ((1, 4), Number(3)),
                                                 ((2, 1), Number(1)),
  ...
  test("Unsolvable puzzle is recognised as such") {
    val puzzle = Puzzle.createPuzzleFromTiles(Map(((1, 1), Number(3)),
                                                  ((1, 2), Number(9)),
                                                  ((1, 3), Number(1)),
                                                  ((1, 4), Number(15)),
                                                  ((2, 1), Number(14)),
  ...
  test("Puzzle without empty tile cannot be created") {
    intercept[IllegalArgumentException](Puzzle.createPuzzleFromTiles(Map(((1, 1), Number(13)),
                                                                        ((1, 2), Number(2)),
                                                                        ((1, 3), Number(10)),
                                                                        ((1, 4), Number(3)))
                                                                    )
